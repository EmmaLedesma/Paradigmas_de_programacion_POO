...
class Empleado:
    ...
    def fichadeempleado(self):
        return f"Empleado {self.nombre} con el sueldo de {self.salario} del área de {self.departamento}"    
...
gerente = Gerente("Romulo Baeza", 1000000, "Contabilidad", 12)
trabajador = Trabajador("Salvador Rodriguez", 250000, "Contabilidad", "hacer reconciliaciones y meter asientos")
