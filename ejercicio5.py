...
gerente = Gerente("Romulo Baeza", 45, "25.200.345", 1000000, "Gerente", "Contabilidad")
empleado1 = Empleado("Paolo Lopez", 34, "34.600.730", 250000, "Analista Contable")
empleado2 = Empleado("Agustín Santigues", 23, "50.345.789", 275000,"Analista Contable" )
